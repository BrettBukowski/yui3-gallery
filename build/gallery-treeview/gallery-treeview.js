  ...
  /**
    ...
    */
    ...
    addPresentationRoles: function(){
        var topElem = new Y.Node(this.getEl()),
            toggleChild = this.getToggleEl().firstChild;

        topElem.all('div.ygtvspacer, tr.ygtvrow').each(function(elem) {
            setAriaRole(elem, _PRESENTATION);
        });
        topElem.all('table.ygtvtable').each(function(elem) {
            setAriaRole(elem, _PRESENTATION);
            setAriaRole(elem.get('firstChild'), _PRESENTATION);
        }),
